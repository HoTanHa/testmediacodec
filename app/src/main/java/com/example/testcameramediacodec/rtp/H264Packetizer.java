...
package com.example.testcameramediacodec.rtp;
...
public class H264Packetizer extends AbstractPacketizer implements Runnable {
    ...
    public void setStreamParameters(byte[] pps1, byte[] sps1) {
        if (pps1 == null || sps1 == null) {
            return;
        }
        if (pps != null && sps != null) {
            return;
        }
        this.pps = new byte[pps1.length];
        this.sps = new byte[sps1.length];

        System.arraycopy(sps1, 0, sps, 0, sps.length);
        System.arraycopy(pps1, 0, pps, 0, pps.length);
